...
abstract class AppColors {
  static const Color pageBackground = Color(0xFF0E0D0D);
  ...
  static const Color colorSecondary = Color(0xFFFF016B);
  ...
  static const Color textColorPrimary = Color(0xFFFCFCFC);
  static const Color textColorSecondary = Color(0xFF3A3A3A);
  ...
  static const Color textColorGrey100 = Color(0xFFFCFCFC);
  static const Color textColorGrey200 = Color(0xFFF5F5F5);
  static const Color textColorGrey500 = Color(0xFFD9D9D9);
  static const Color colorBlack300 = Color(0xFF3A3A3A);
  static const Color colorBorderGrey  = Color(0xFF202020);
